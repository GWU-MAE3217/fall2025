...
:::{.callout-important}
- You are encouraged to bring your own personal machine or laptop to the laboratory and recitations. 
...
- Install the following pieces of Python IDEs on your personal machine:
  - [Anaconda](https://www.anaconda.com/download/success) 
  - [Thonny](https://thonny.org)
- Join [EdStem](https://edstem.org/us/join/XjP3Wp) for the course discussion board where you can ask questions and connect with your colleagues and the instruction team.
- See the data from Lab-0, the Tin Foil Experiment<a href="/documents/TinFoil_DataPlot.html" target="_blank"><strong> here</strong>
:::
